...
results_directory = "../../data/Meta_Analysis_Results/Results_2025-02-15/"
...
rtable_infection = readRDS(paste0(results_directory,"rtable_infection_bestfit.rds"))
...
rtable_strain_bestfit[STUDY_TYPE_SIMPLE == "All",
  ...
  align(align = "center", part = "header", i = 1)%>%autofit()%>%fix_border_issues()
```
